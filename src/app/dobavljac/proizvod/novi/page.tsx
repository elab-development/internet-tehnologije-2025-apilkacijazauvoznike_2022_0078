        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="space-y-2">
            <div className="inline-flex rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-slate-600">
              Dobavljač | Novi proizvod
            </div>
            <h1 className="text-2xl font-semibold tracking-tight text-slate-900">
              Novi proizvod
            </h1>
            <p className="max-w-3xl text-sm text-slate-600">
              Dodavanje novog proizvoda u ponudu dobavljača sa osnovnim
              podacima, dimenzijama, cenom i kategorijom.
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Button
              ...
              onClick={() =>
                router.push(
                  `/dobavljac/kategorije/nova?returnTo=${encodeURIComponent("/dobavljac/proizvod/novi")}`
                )
              }
            >
              + Nova kategorija
